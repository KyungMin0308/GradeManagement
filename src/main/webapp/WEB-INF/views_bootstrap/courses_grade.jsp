...
<html>
    <head>
        ...
        <title>Academic Management Course Grade</title>
        <!-- Favicon-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">학기별 수강 과목 및 <br> 성적 조회</h1>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-outline-light btn-lg px-4" href="${pageContext.request.contextPath}/semester_course">BACK</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <table class="coursetable">
						...
						<c:forEach var="course" items="${courses_grade}">
							<c:set var="year" value="${course.year}"></c:set>
							<c:set var="sem" value="${course.semester}"></c:set>
							<tr class="insideline">
