...
<html>
    <head>
        ...
        <title>Grade Management Create Success</title>
        <!-- Favicon-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">예비 수강 신청 성공</h1>
                            <p class="lead text-white-50 mb-4">예비 수강 신청에 성공하였습니다.</p>
