...
<html>
    <head>
        ...
        <title>Academic Management Delete Success</title>
        <!-- Favicon-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">예비 수강 신청 삭제</h1>
                            <p class="lead text-white-50 mb-4">예비 수강 신청이 성공적으로 삭제되었습니다.</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-outline-light btn-lg px-4" href="${pageContext.request.contextPath}/">HOME</a>
                            </div>
                        </div>
                    </div>
                </div>
